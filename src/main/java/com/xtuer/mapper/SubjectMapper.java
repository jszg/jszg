...
public interface SubjectMapper {
    ...
    List<Subject> findByParentAndProvince(@Param("parent") int parent, @Param("teachGrade") int teachGrade, @Param("province") int province);
    List<Subject> findByCertTypeAndOrg(@Param("certTypeId") int certTypeId, @Param("orgId") int orgId);
    ...
    //非统考第三步加载任教学科树子节点
    List<Subject> findChildByCertTypeAndProvince(@Param("provinceId") int provinceId,  @Param("teachGrade") int teachGrade, @Param("parentId") int parentId);
    ...
    //注册报名证书上的任教学科子节点
    List<Subject> findByParentCertTypeAndOrgAndStatus(@Param("parentId") int parentId, @Param("orgId") int orgId);
